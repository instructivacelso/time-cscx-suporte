...
/**
 * Fuso da escola. O servidor roda em UTC, então sem isto as datas apareceriam
 * 3 horas adiantadas — um acesso das 22h de ontem viraria 1h de hoje.
 * Pode ser trocado pela variável TIMEZONE, se um dia houver operação em outro fuso.
 */
export const TIMEZONE = process.env.NEXT_PUBLIC_TIMEZONE || 'America/Sao_Paulo';
...
/** Só a hora, para linhas de histórico do mesmo dia. */
...
/** Data de hoje no fuso da escola, no formato AAAA-MM-DD. */
